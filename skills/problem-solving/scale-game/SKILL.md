---
name: scale-game
description: Tests at extremes (1000x bigger/smaller) to expose fundamental truths. Use when uncertain about scalability, edge cases unclear, or validating architecture for production.
---
