---
name: when-stuck
description: Dispatches to the right problem-solving technique based on how you're stuck. Use when stuck and unsure which problem-solving technique to apply.
---
