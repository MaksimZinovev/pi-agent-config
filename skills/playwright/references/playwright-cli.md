...
For complete details run `playwright-cli --help` or explore https://github.com/microsoft/playwright-cli
...
```shell
 ...
 Global options:
   --config <path>             use custom configuration file, defaults to "playwright-cli.json"
   --headed                    run in headed mode
   --help [command]            print help
   --session                   run command in the scope of a specific session
